...
(function(){
  ...
  @media(max-width:920px){
    ...
    .card{padding:16px!important;border-radius:24px!important;overflow:hidden!important}
    .title{font-size:34px!important;line-height:1.08!important}
    ...
    .week-number{white-space:nowrap!important;font-size:16px!important}.week-title{font-size:13px!important;line-height:1.35!important}
  ...
  var l=document.createElement('link');l.rel='stylesheet';l.href='plan-redesign.css?v=0713m';document.head.appendChild(l);
  var j=document.createElement('script');j.src='plan-redesign.js?v=0713m';document.body.appendChild(j);
})();